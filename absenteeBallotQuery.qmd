...
remDr$navigate("https://www.ohiosos.gov/globalassets/elections/2023/gen/ohiososabreport-20231113.xlsx")

file_links <- remDr$findElements(using = "css selector", value = "a[href$='.xlsx']")
